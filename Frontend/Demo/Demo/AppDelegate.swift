...
//  Demo
//
//  Created by lethanhtam on 6/25/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func createMenuView() {
        ...
        SlideMenuOptions.leftViewWidth = ScreenSize.SCREEN_WIDTH - 60
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "thanhtam.le.Demo" in the application's documents Application Support directory.
